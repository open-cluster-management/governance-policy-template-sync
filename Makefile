...
############################################################
build-instrumented:
	go test -covermode=atomic -coverpkg=github.com/open-cluster-management/$(IMG)/cmd...,github.com/open-cluster-management/$(IMG)/pkg... -c -tags e2e ./cmd/manager -o build/_output/bin/$(IMG)-instrumented
